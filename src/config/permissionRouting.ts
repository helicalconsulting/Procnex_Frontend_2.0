...
export const ROUTE_PERMISSION_RULES: Array<{ prefix: string; rule: RoutePermissionRule }> = [
  ...
  { prefix: '/accounts-payable', rule: { module: 'Approvals', action: 'canView' } },
  { prefix: '/payments', rule: { module: 'Approvals', action: 'canView' } },
  { prefix: '/sales-orders', rule: { module: 'Approvals', action: 'canView' } },
...
export const MENU_ITEM_PERMISSIONS: Record<string, RoutePermissionRule> = {
  ...
  'sales-orders': { module: 'Approvals', action: 'canView' },
