...
export const MOCK_QUOTATIONS: Quotation[] = [
  // Acme Tech Solutions (Vendor 1) - RFQ 1 Version History: Q1 (Returned), Q2 (Returned), Q3 (Active)
  {
    id: '1-v1',
    rfqId: '1',
    vendorId: '1',
    ...
    score: 3.8,
    status: 'RETURNED',
    returnReason: 'Price is above budget and lead time is too long. Please submit a competitive revision.',
    returnComment: 'Price is above budget and lead time is too long. Please submit a competitive revision.',
    submittedAt: '2025-01-25T10:00:00.000Z',
    vendor: MOCK_VENDORS[0],
    items: MOCK_QUOTATION_ITEMS.filter((i) => i.quotationId === '1'),
    versionNumber: 1,
    qNo: 'Q1',
    vendorQuotationNumber: 'ACM-QT-2025-01',
    isLatestVersion: false,
    bidSecurityValueType: 'FIXED_AMOUNT',
    bidSecurityValue: 100000,
    bidSecurityCurrency: 'KES',
    bidSecurityValidityValue: 90,
    bidSecurityValidityUnit: 'DAYS',
    bidSecurityBondNumber: 'BB-001',
    bidSecurityIssuer: 'KCB Bank',
    bidBondNumber: 'BB-001',
    bidBondIssuer: 'KCB Bank',
    bidBondAmount: 100000,
    bidBondValidityValue: 90,
    customFieldValues: { 'Warranty Period': '12 Months', 'Country of Origin': 'Kenya' },
  },
  {
    id: '1-v2',
    rfqId: '1',
    ...
    score: 4.1,
    status: 'RETURNED',
    returnReason: 'Payment terms need to be NET 30 minimum. Please update.',
    returnComment: 'Payment terms need to be NET 30 minimum. Please update.',
    submittedAt: '2025-01-28T14:30:00.000Z',
    vendor: MOCK_VENDORS[0],
    items: MOCK_QUOTATION_ITEMS.filter((i) => i.quotationId === '1'),
    versionNumber: 2,
    qNo: 'Q2',
    vendorQuotationNumber: 'ACM-QT-2025-02',
    parentQuotationId: '1-v1',
    isLatestVersion: false,
    bidSecurityValueType: 'FIXED_AMOUNT',
    bidSecurityValue: 100000,
    bidSecurityCurrency: 'KES',
    bidSecurityValidityValue: 90,
    bidSecurityValidityUnit: 'DAYS',
    bidSecurityBondNumber: 'BB-002',
    bidSecurityIssuer: 'Equity Bank',
    bidBondNumber: 'BB-002',
    bidBondIssuer: 'Equity Bank',
    bidBondAmount: 100000,
    bidBondValidityValue: 90,
    customFieldValues: { 'Warranty Period': '24 Months', 'Country of Origin': 'Kenya' },
  },
  {
    id: '1',
    rfqId: '1',
    ...
    versionNumber: 3,
    qNo: 'Q3',
    vendorQuotationNumber: 'ACM-QT-2025-03',
    parentQuotationId: '1-v2',
    ...
    bidSecurityValidityValue: 90,
    bidSecurityValidityUnit: 'DAYS',
    bidSecurityBondNumber: 'BB-003',
    bidSecurityIssuer: 'Equity Bank',
    bidBondNumber: 'BB-003',
    bidBondIssuer: 'Equity Bank',
    bidBondAmount: 100000,
    bidBondValidityValue: 90,
    customFieldValues: { 'Warranty Period': '24 Months', 'Country of Origin': 'Kenya' },
  ...
  // Global Supply Corp (Vendor 2) - RFQ 1 Version History: Q1 (Returned), Q2 (Active)
  {
    id: '2-v1',
    rfqId: '1',
    vendorId: '2',
    ...
    score: 3.9,
    status: 'RETURNED',
    returnReason: 'Please review pricing against technical specifications.',
    returnComment: 'Please review pricing against technical specifications.',
    submittedAt: '2025-01-27T09:00:00.000Z',
    vendor: MOCK_VENDORS[1],
    items: MOCK_QUOTATION_ITEMS.filter((i) => i.quotationId === '2'),
    versionNumber: 1,
    qNo: 'Q1',
    vendorQuotationNumber: 'GSC-QT-101',
    isLatestVersion: false,
    bidSecurityValueType: 'FIXED_AMOUNT',
    bidSecurityValue: 50000,
    bidSecurityCurrency: 'KES',
    bidSecurityValidityValue: 60,
    bidSecurityValidityUnit: 'DAYS',
    bidSecurityBondNumber: 'GSC-BB-101',
    bidSecurityIssuer: 'Stanbic Bank',
    bidBondNumber: 'GSC-BB-101',
    bidBondIssuer: 'Stanbic Bank',
    bidBondAmount: 50000,
    bidBondValidityValue: 60,
  },
  {
    id: '2',
    rfqId: '1',
    ...
    versionNumber: 2,
    qNo: 'Q2',
    vendorQuotationNumber: 'GSC-QT-102',
    parentQuotationId: '2-v1',
    isLatestVersion: true,
  },
  ...
  // RFQ 2 Quotations
  {
    ...
    versionNumber: 1,
    qNo: 'Q1',
    vendorQuotationNumber: 'GSC-QT-201',
    isLatestVersion: true,
  },
  ...
  // RFQ 3 Quotations
  {
    ...
    versionNumber: 1,
    qNo: 'Q1',
    vendorQuotationNumber: 'ACM-QT-301',
    isLatestVersion: true,
  },
];
