...
const MODULE_PERMISSIONS: Record<string, Record<string, ModulePermission>> = {
  [RoleName.SUPER_ADMIN]: {
    ...
    Signature: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    'Digital Signatures': { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
  ...
  [RoleName.PROCUREMENT_MANAGER]: {
    RFQ: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Quotation: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Quotations: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Contracts: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Contract: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    PurchaseOrder: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    'Purchase Orders': { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Vendor: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Vendors: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    ApprovalManagement: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Approvals: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    Signature: { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
    'Digital Signatures': { canView: true, canCreate: true, canApprove: true, canEdit: true, canDelete: true },
...
export const NAVIGATION_MENU: MenuItem[] = [
  {
    ...
    label: 'Dashboard',
    path: '/dashboard',
    roles: [RoleName.SUPER_ADMIN, RoleName.PROCUREMENT_MANAGER, RoleName.FINANCE_MANAGER, RoleName.FINANCE_APPROVER, 'Purchase Manager', 'purchase_manager', 'procurement_manager'],
  },
  {
    id: 'rfq',
